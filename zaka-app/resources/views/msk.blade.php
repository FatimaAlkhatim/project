    ...
    <h5 class="card-header" style="text-align:center;"> ....خدمات المذكين</h5>
      ...
      <h5 style="text-align:center;"><a href="{{ url('index') }}" style="color:white; ">الذهاب الي خدمات المذكين</a></h5>
        <p class="card-text"style="  text-align:right;">
         يقوم العاملون على جباية أموال الزكاة، بحساب المقادير المترتبة على المكلفين من زكاة، من الأموال التي تكون ظاهرة لهم، من زروع وأنعام،  ومعادن والاعتماد هنا على ما يظهر من أموال، فيقوم الجباة بحساب المال الظاهر لدى المكلف، وتحديد وجوب الزكاة فيه  ثم تحديد      المقدار                   
      </p>
      </div>
    </div>
  </div>
    ...
    <h5 class="card-header" style="text-align:center;"> ....خدمات المذكين</h5>
      ...
      <h5 style="text-align:center;"><a href="{{ url('index') }}" style="color:white;  text-align:center;">الذهاب الي خدمات المذكين</a></h5>
        <p class="card-text"style="  text-align:right;"> 
         ...
         نظام فرضته الشريعه الاسلاميه وطبقه النبي صلي الله عليه وسلم وتعني الالتزام بمعايير العداله التي تمنع من اجبار الناس علي الزكاة بأفضل م عندهم وهو كرائم أموالهم مع استيفائها كامله 
                              </p>
      </div>
    </div>
  </div>
