...
<div class="mb-6">
 <input type="text" name="amount_py"  value="{{$farmarie}}" class="form-control" id="exampleFormControlInput1" placeholder=" ادخل المبلغ"  style="width: 400px; text-align:right;">
</div>
<br>
