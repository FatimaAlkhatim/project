  ...
  <div class="col-sm-6 ">
    ...
    <h5 class="card-header" style="text-align:center;"> ....خدمات المذكين</h5>
      ...
      <!-- <h5 style="text-align:center;"><a href="{{ url('index') }}" style="color:white; ">الذهاب الي خدمات المذكين</a></h5> -->
        ...
        يقوم العاملون على جباية أموال الزكاة، بحساب المقادير المترتبة على المكلفين من زكاة، من الأموال التي تكون ظاهرة لهم، من زروع وأنعام، والاعتماد هنا على ما يظهر من أموال، فيقوم الجباة بحساب المال الظاهر لدى المكلف، وتحديد وجوب الزكاة فيه أم لا، إن كانت الزكاة واجبة في المال                     
      </p>
      </div>
    </div>
  </div>
